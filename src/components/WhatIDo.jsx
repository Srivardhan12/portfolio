...
export default function WhatDoIDo() {
    const textParas = ["I create purposeful digital experiences. ", "Passionate about coding, crafting sleek ", "designs, and bringing ideas to life interactively."]
    ...
    return (
        <div className='px-10 b-100 flex justify-center align-middle flex-col w-11/12 m-auto h-screen'>
            <h2 className='c-100 px-10 uppercase pb-5 text-base font-medium tracking-widest'>What i do?</h2>
            {textParas.map((el) => {
