...
export default function Main() {
  return (
    <div className="landing b-200 flex justify-center items-center h-screen w-full m-auto flex-col relative">
      <div className="box">
        <p className="c-100 uppercase lg:text-8xl md:text-5xl font-semibold lg:text-start md:text-center md:mr-24">
          Hello there, I'm
        </p>
        <h1 className="c-100 pt-10 uppercase lg:text-8xl md:text-5xl font-semibold lg:text-end md:text-center md:ml-32">
          Srivardhan
        </h1>
        {/* <div>
      ...
      <div>
        ...
        <p className="absolute mt-40 bounce-ball animate-bounce w-10 h-10 b-100 mx-auto c-200 text-center">
          &darr;
        </p>
